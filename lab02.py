...
input("roll dice to choose a weapon (press enter)")
weaponRoll=random.choice(diceOptions)
weaponRoll-=1
print (f"you rolled {1+weaponRoll} for a weapon.")
combatStrength += 1+ weaponRoll
chooseWeapon=weapons[weaponRoll]
print(f"selected weapon is {chooseWeapon}")
if weaponRoll <=1:
